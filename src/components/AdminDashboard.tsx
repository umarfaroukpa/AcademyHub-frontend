...
import { Shield, Users, BookOpen, CheckCircle, XCircle, Clock, AlertCircle, GraduationCap, Settings, BarChart3, Filter, Search, MoreVertical, Edit, Trash2, UserPlus, BookPlus} from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const handleError = (error: any, context: string) => {
    ...
    if (error.response?.status === 401) {
      ...
      setError(`Failed to fetch ${context}: ${error.response?.data?.error || error.message}`);
    }
  };
